...
// }
void number_1::Print_First_Number(void)
{
    cout << "So the First Number after swaping Value is " << a;
}
void number_2::Print_Second_Number(void)
{
    cout << " And the Second Number after swaping Value is " << b;
}
int main()
{
    number_1 object_1;
   ...
   // printswapednumber(object_1, object_2);
    object_1.Print_First_Number();
    object_2.Print_Second_Number();
